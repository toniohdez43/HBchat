...
class ChatViewController:  JSQMessagesViewController, UIActionSheetDelegate, OneMessageDelegate,ContactPickerDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate,UINavigationControllerDelegate {
...
var messages = NSMutableArray()
    ...
    override func didPressAccessoryButton(sender: UIButton!) {
        ...
        var sheet : UIActionSheet = UIActionSheet(title:"Media messages",
            delegate:self,
            cancelButtonTitle:"Cancel",
            
            destructiveButtonTitle:nil,
            
            otherButtonTitles:"Send photo", "Send location", "Send video", "Send audio")
    ...
    func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        let img : UIImage!=UIImage(named: "IMG")
        var photoItem:JSQPhotoMediaItem = JSQPhotoMediaItem(image: img)
        print(photoItem)
        var photoMessage:JSQMessage  = JSQMessage(senderId: senderId, displayName: senderDisplayName,media: photoItem)
    ...
    func actionSheet(actionSheet: UIActionSheet, clickedButtonAtIndex buttonIndex: Int) {
        ...
        case 2:
                ...
                var weakView : UICollectionView = self.collectionView
